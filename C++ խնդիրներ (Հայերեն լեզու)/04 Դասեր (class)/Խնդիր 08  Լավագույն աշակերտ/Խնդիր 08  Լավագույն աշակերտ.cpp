// Խնդիր 08  Լավագույն աշակերտ.cpp

/* Գրել ծրագիր, որը մուտքում կստանա դասարանի աշակերտների քանակը ապա յուրաքանչյուրի անունն և 5 առարկաների քննությունների գնահատականները։ Ծրագիրը պետք է արտածի ամենաբարձր միջին որակական գնահատական ունեցող աշակերտի անունը։ */
