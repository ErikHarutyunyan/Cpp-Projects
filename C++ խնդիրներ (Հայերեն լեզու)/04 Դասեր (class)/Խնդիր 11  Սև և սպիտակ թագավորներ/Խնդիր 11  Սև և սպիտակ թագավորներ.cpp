// Խնդիր 11  Սև և սպիտակ թագավորներ.cpp

/* Մուտքում հերթականությամբ տրվում է շախմատի տախտակի վրա գտնվող սպիտակ և սև թագավորների վանդակների համարները, ապա N բնական թիվը և հաջորդականություն N շախմատի վանդակների համարներից բաղկացած։ Պահանջվում է արտածել YES եթե սպիտակ թագավորը կարող է ուտել սևին առանց անցնելու նշված N վանդակներից որևիցե մեկով, համարելով, որ սև թագավորը անշարժ է և NO՝ հակառակ դեպքում։ Խնդիրը լուծելիս օգտագործել հերթ։ */
