// Task 12 First digits.cpp

/* Write a program that gets a natural number N (n ≤ 1000) in the input, followed by a sequence of N characters. As a result, the program should state the sequence numbers, and then the rest of the characters. The displayed characters must be separated by spaced. When solving the problem, use an array. */
