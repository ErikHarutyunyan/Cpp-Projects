// Задача 8  Лучший ученик.cpp

/* Напишите программу, которая получит количество учеников в классе, затем имя каждого и 5 оценок за экзамен по предмету. В программе должно быть указано имя студента с наивысшей средней оценкой. */
